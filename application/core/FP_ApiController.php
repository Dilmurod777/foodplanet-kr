...
class FP_ApiController extends CI_Controller
{
	public $data = array();
	...
	public function remove_script($str)
	{
	...
	public function pagination($num_links, $total_rows, $offset, $perpage)
	{
		$result = '';
	...
	public function check_passowrd($val) {
