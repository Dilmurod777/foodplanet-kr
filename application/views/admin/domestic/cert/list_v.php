                    	...
                    	<div class="ibox ">
                        	<div class="ibox-content">
								<div class="form-group float-right text-right col-lg-6">
									<a href="/admin/domestic/cert/register" class="btn btn-primary">인증정보등록</a>
								</div>
                            	...
                            	<table class="footable table table-stripped">
									...
									?>
                                                <tr>
													...
													<td class="text-center"><?php echo $row['cert_name']; ?></td>
													<td class="text-center"><img src="<?php echo $row['cert_img']; ?>" style="max-width:100px; max-height:100px;" ></td>
...
function goPage(offset) {
	$('#frmSearch').attr('action', '/admin/domestic/cert/list');
...
function goDetail(seq) {
	...
	$('#frmSearch').attr('action', '/admin/domestic/cert/edit');
	$('#frmSearch').submit();
}
