    ...
    <div id="page-wrapper" class="gray-bg">
		...
		<div class="wrapper wrapper-content animated fadeInRight">
                        ...
                        <div class="ibox ">
							<form id="frmSave">
                                ...
                                <div class="ibox-content">
	                                ...
	                                <div class="form-group  row">
	                                	<label class="col-sm-2 col-form-label">특허명<code>*</code></label>
										<div class="col-sm-4">
											<input type="text" name="patent_name" class="form-control" maxlength="100" value="<?php echo $info['patent_name']; ?>" />
	                                    </div>
	                                	<label class="col-sm-2 col-form-label">특허명(영문)<code>*</code></label>
										<div class="col-sm-4">
											<input type="text" name="patent_name_eng" class="form-control" maxlength="100" value="<?php echo $info['patent_name_eng']; ?>" />
	                                    </div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
	                                	<label class="col-sm-2 col-form-label">특허이미지<code>*</code></label>
	                                    <div class="col-sm-4" id="img_url_wrap">
											<input type="text" class="form-control" name="patent_img" value="<?php echo $info['patent_img']; ?>" readonly />
										</div>
										<div class="col-sm-1">
											<input type="file" id="patent_img" name="patent_img_attach" style="display:none"  />
											<button type="button" class="btn btn-w-m btn-primary" onclick="javascript:$('#patent_img').click();">추가</button>
	                                    </div>
	                                </div>
			...
			<div class="form-group text-center">
	           	...
	           	<button type="button" class="btn btn-w-m btn-default" onclick="javascript:location.href='/admin/domestic/patent/list'; return false;">목록으로</button>
			</div>
		</div>
    </div>
</div>
...
function fnSave()
{
	...
	$.ajax({
		url: "/api/admin/domestic/patent/edit",
		type: "POST",
		data: data,
		...
		success:function(data){
			data = JSON.parse(data);
       		if(data.result == 'login') {
                ...
                alert(data.msg);
                location.href='/admin/domestic/patent/list';
       		}
       	},
        error:function(data){
    		fnHideLoad();
...
function fnDelete() {
	...
	$.ajax({
		url: "/api/admin/domestic/patent/delete",
		type: "POST",
