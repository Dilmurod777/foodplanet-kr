							...
							<form id="frmSearch" method="post" action="/admin/domestic/facilities/list" >
								...
								<div class="ibox-content">
									<div class="row">
										...
										<div class="col-lg-4">
											<input type="text" placeholder="제조사명, 설비명 검색" value="<?php echo !empty($req) ? $req['keyword'] : ''; ?>" name="keyword" id="keyword" class="form-control" />
										</div>
									</div>
								</div>
							</form>
                    	...
                    	<div class="ibox ">
                        	<div class="ibox-content">
								<div class="form-group float-right text-right col-lg-6">
									<a href="/admin/domestic/facilities/register" class="btn btn-primary">설비정보등록</a>
								</div>
                            	...
                            	<table class="footable table table-stripped">
									...
									?>
                                                <tr>
													...
													<td class="text-center"><?php echo $row['img_desc']; ?></td>
...
function goPage(offset) {
	$('#frmSearch').attr('action', '/admin/domestic/facilities/list');
...
function goDetail(seq) {
	...
	$('#frmSearch').attr('action', '/admin/domestic/facilities/edit');
	$('#frmSearch').submit();
}
