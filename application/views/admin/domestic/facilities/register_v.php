    ...
    <div id="page-wrapper" class="gray-bg">
		...
		<div class="wrapper wrapper-content animated fadeInRight">
							...
							<form id="frmSave">
                                <div class="ibox-content">
	                                ...
	                                <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="img_desc" class="form-control" maxlength="100" />
	                                    </div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
			...
			<div class="form-group text-center">
	           	...
	           	<button type="button" class="btn btn-w-m btn-default" onclick="javascript:location.href='/admin/domestic/facilities/list'; return false;">목록으로</button>
			</div>
		</div>
    </div>
</div>
...
function fnSave()
{
	...
	$.ajax({
		url: "/api/admin/domestic/facilities/register",
		type: "POST",
		data: data,
