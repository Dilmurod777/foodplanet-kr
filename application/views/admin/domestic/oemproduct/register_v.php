							...
							<form id="frmSave">
                                <div class="ibox-content">
                                    <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="company_name" class="form-control" maxlength="50" readonly />
	                                    </div>
                                    </div>
	                                ...
	                                <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="product_name" class="form-control" maxlength="50" />
	                                    </div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
									...
									<div class="form-group  row">
										...
										<?php
											foreach($category as $row) {
												...
												echo '	<input type="radio" id="category_' .  $row['sub_code'] . '" name="category" value="' . $row['sub_code'] . '"  >';
										...
										<div class="col-lg-10 category_etc" style="display:none">
											<input type="text" class="form-control" name="category_etc" value="" placeholder="" />
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									<div class="form-group  row">
										<label class="col-lg-2 col-form-label">대표 OEM기업<code>*</code></label>
										<div class="col-lg-10 row">
										<?php
											foreach($company as $row) {
												echo '<div class="col-lg-3 check_wrap">';
												echo '	<input type="radio" id="company_' .  $row['sub_code'] . '" name="main_oem" value="' . $row['code_name'] . '"  >';
												echo '	<label for="company_' .  $row['sub_code'] . '">' . $row['code_name'] . '</label>';
												echo '</div>';
											}
										?>
										</div>
	                                ...
	                                <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="supply_price" class="form-control onlyNumber2" maxlength="50" />
	                                    </div>
	                                	<label class="col-sm-2 col-form-label">MOQ</label>
										<div class="col-sm-4">
											<input type="text" name="moq" class="form-control onlyNumber2" maxlength="50" />
	                                    </div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="delivery_day" class="form-control onlyNumber" maxlength="50" />
	                                    </div>
	                                	<label class="col-sm-2 col-form-label">식품유형</label>
										<div class="col-sm-4">
											<input type="text" name="product_type" class="form-control" maxlength="50" />
	                                    </div>
	                                </div>
									<div class="hr-line-dashed"></div>
									<div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="weight" class="form-control " maxlength="20" />
	                                    </div>
	                                	<label class="col-sm-2 col-form-label">단위</label>
										<div class="col-sm-4">
											<input type="text" name="unit" class="form-control" maxlength="10" />
	                                    </div>
									</div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="storage" class="form-control" maxlength="50" />
	                                    </div>
	                                	<label class="col-sm-2 col-form-label">소비기한</label>
										<div class="col-sm-4">
											<input type="text" name="expire_day" class="form-control" maxlength="50" />
	                                    </div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="qty" class="form-control onlyNumber2" maxlength="50" />
	                                    </div>
	                                	<label class="col-sm-2 col-form-label">입수 단위</label>
										<div class="col-sm-4">
											<input type="text" name="qty_unit" class="form-control" maxlength="10" />
	                                    </div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="container_type" class="form-control" maxlength="50" />
	                                    </div>
	                                	<label class="col-sm-2 col-form-label">채널별 납품현황</label>
										<div class="col-sm-4">
											<input type="text" name="channel_status" class="form-control" maxlength="100" />
	                                    </div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
										...
										<div class="col-sm-4 row">
											<div class="col-lg-3 check_wrap">
												<input type="radio" id="is_main_y" name="is_main" value="y"  >
												<label for="is_main_y">등록</label>
											</div>
											<div class="col-lg-3 check_wrap">
												<input type="radio" id="is_main_n" name="is_main" value="n" checked >
...
function fnSave()
{
	...
	$.ajax({
		url: "/api/admin/domestic/oemproduct/register",
		type: "POST",
		data: data,
		...
		success:function(data){
			data = JSON.parse(data);
       		if(data.result == 'login') {
                ...
                alert(data.msg);
                location.href='/admin/domestic/oemproduct/list';
       		}
       	},
        error:function(data){
    		fnHideLoad();
...
function fnCheckBizno() {
	$.ajax({
		url: "/api/admin/domestic/oemproduct/chk_bizno",
		type: "POST",
