        ...
        <div id="page-wrapper" class="gray-bg">
        	...
        	<div class="wrapper wrapper-content animated fadeInRight">
				<div class="row">
                	<div class="col-lg-12">
                    	<div class="ibox ">
							<form id="frmSearch" method="post" action="/admin/domestic/nbproduct/list" >
                    	...
                    	<div class="ibox ">
                        	<div class="ibox-content">
								<div class="form-group float-right text-right col-lg-6">
									<a href="/admin/domestic/nbproduct/register" class="btn btn-primary">자사제품등록</a>
								</div>
...
function goPage(offset) {
	$('#frmSearch').attr('action', '/admin/domestic/nbproduct/list');
...
function goDetail(seq) {
	...
	$('#frmSearch').attr('action', '/admin/domestic/nbproduct/edit');
	$('#frmSearch').submit();
}
