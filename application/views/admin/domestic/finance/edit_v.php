							...
							<form id="frmSave">
                                <div class="ibox-content">
									<div class="form-group  row">
                                        <label class="col-lg-2 col-form-label">사업자명</label>
	                                    <div class="col-lg-4 ">
											<input type="text" class="form-control" maxlength="12" disabled value="<?php echo $info['company_name']; ?>" />
	                                    </div>
	                                </div>
                                    ...
                                    <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="base_year" class="form-control onlyNumber" maxlength="4" readonly value="<?php echo $info['base_year']; ?>" />
	                                    </div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="sales_year" class="form-control" maxlength="100" value="<?php echo $info['sales_year']; ?>" />
	                                    </div>
	                                	<label class="col-sm-2 col-form-label">영업이익<code>*</code></label>
										<div class="col-sm-4">
											<input type="text" name="biz_profits" class="form-control" maxlength="100" value="<?php echo $info['biz_profits']; ?>" />
	                                    </div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
										...
										<div class="col-sm-4">
											<input type="text" name="current_profits" class="form-control" maxlength="100" value="<?php echo $info['current_profits']; ?>" />
	                                    </div>
...
function fnSave()
{
	...
	$.ajax({
		url: "/api/admin/domestic/finance/edit",
		type: "POST",
		data: data,
...
function fnDelete() {
	...
	$.ajax({
		url: "/api/admin/domestic/finance/delete",
		type: "POST",
		data: {biz_no : $('input[name=biz_no]').val(), base_year : $('input[name=base_year]').val()},
		dataType : 'JSON',
		async : false,
		success:function(data){
       		if(data.result == 'login') {
