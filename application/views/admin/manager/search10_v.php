        ...
        <div id="page-wrapper" class="gray-bg">
        	...
        	<div class="wrapper wrapper-content animated fadeInRight">
                        	...
                        	<div class="ibox-content">
                            	...
                            	<table class="footable table table-stripped">
                                    ...
                                    <?php
											...
											echo '<tr><td colspan="100%" class="text-center">검색된 검색어가 없습니다.</td></tr>';	
										}
									?>
                                	</tbody>
                            	</table>
                ...
                <div class="form-group text-center">
                    <button type="button" class="btn btn-w-m btn-success" onclick="javascript:fnShowRegister(); return false;">검색어추가</button>
                </div>
