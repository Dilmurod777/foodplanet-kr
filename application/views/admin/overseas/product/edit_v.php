							...
							<form id="frmSave">
                                ...
                                <div class="ibox-content">
                                    <div class="form-group  row">
	                                    ...
	                                    <div class="col-lg-4 ">
											<input type="text" name="product_name_eng"  class="form-control" value="<?php echo $info['product_name_eng']; ?>" />
	                                    </div>
                                    </div>
	                                ...
	                                <div class="form-group  row">
	                                    ...
	                                    <div class="col-sm-4" id="product_img_wrap">
											<input type="text" class="form-control" value="<?php echo $info['product_img']; ?>" disabled />
										</div>
										<div class="col-sm-1">
                                    ...
                                    <div class="form-group  row">
	                                    ...
	                                    <div class="col-lg-10 ">
											<textarea name="summary" class="form-control" rows="3"><?php echo $info['summary']; ?></textarea>
	                                    </div>
                                    </div>
...
function fnSave()
{
	...
	$.ajax({
		url: "/api/admin/overseas/product/edit",
		type: "POST",
		data: data,
...
function fnDelete() {
	...
	$.ajax({
		url: "/api/admin/overseas/product/delete",
		type: "POST",
