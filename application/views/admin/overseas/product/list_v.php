        ...
        <div id="page-wrapper" class="gray-bg">
        	...
        	<div class="wrapper wrapper-content animated fadeInRight">
				<div class="row">
                	<div class="col-lg-12">
                    	<div class="ibox ">
							<form id="frmSearch" method="post" action="/admin/overseas/product/list" >
								...
								<div class="ibox-content">
									<div class="row">
										...
										<div class="col-lg-4">
											<input type="text" placeholder="품목명 검색" value="<?php echo !empty($req) ? $req['keyword'] : ''; ?>" name="keyword" id="keyword" class="form-control" />
										</div>
									</div>
								</div>
							</form>
                    	...
                    	<div class="ibox ">
                        	<div class="ibox-content">
								...
								<div class="form-group float-right text-right col-lg-6">
									<a href="/admin/overseas/product/register" class="btn btn-primary">제품등록</a>
								</div>
                            	<table class="footable table table-stripped">
                                	<thead>
                                		<tr>
		                                    ...
		                                    <th class="text-center">품목명(영문)</th>
									...
									?>
                                                <tr>
													...
													<td class="text-center"><?php echo $row['hscode']; ?></td>
...
function goPage(offset) {
	$('#frmSearch').attr('action', '/admin/overseas/product/list');
	$('input[name=offset]').val(offset);
	$('#frmSearch').submit();
}

function goDetail(seq) {
	$('#frmSearch').attr('action', '/admin/overseas/product/edit');
