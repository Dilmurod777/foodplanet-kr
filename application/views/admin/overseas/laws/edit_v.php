    ...
    <div id="page-wrapper" class="gray-bg">
		...
		<div class="wrapper wrapper-content animated fadeInRight">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="form-group  row">
	                                    ...
	                                    <div class="col-lg-4 row">
											<input type="text" name="law_kind" value="<?php echo $info['law_kind']; ?>" class="form-control" />
										</div>
	                                ...
	                                <div class="hr-line-dashed"></div>
                                    <div class="form-group  row">
                                        <label class="col-lg-2 col-form-label">법령<code>*</code></label>
	                                    <div class="col-lg-10 ">
											<textarea name="laws" class="form-control" rows="5"><?php echo $info['laws']; ?></textarea>
	                                    </div>
                                    </div>
	                                <div class="hr-line-dashed"></div>
                                    <div class="form-group  row">
                                        <label class="col-lg-2 col-form-label">상세설명<code>*</code></label>
	                                    <div class="col-lg-10 ">
			...
			<div class="form-group text-center">
	           	...
	           	<button type="button" class="btn btn-w-m btn-default" onclick="javascript:location.href='/admin/overseas/laws/list'; return false;">목록으로</button>
			</div>
		</div>
    </div>
</div>
...
function fnSave()
{
	...
	$.ajax({
		url: "/api/admin/overseas/laws/edit",
		type: "POST",
		data: data,
		...
		success:function(data){
			data = JSON.parse(data);
       		if(data.result == 'login') {
                ...
                alert(data.msg);
                location.href='/admin/overseas/laws/list';
       		}
       	},
        error:function(data){
    		fnHideLoad();
...
function fnDelete() {
	...
	$.ajax({
		url: "/api/admin/overseas/laws/delete",
		type: "POST",
