        ...
        <div id="page-wrapper" class="gray-bg">
        	...
        	<div class="wrapper wrapper-content animated fadeInRight">
				<div class="row">
                	<div class="col-lg-12">
                    	<div class="ibox ">
							<form id="frmSearch" method="post" action="/admin/overseas/nation/list" >
								...
								<div class="ibox-content">
									<div class="row">
										...
										<div class="col-lg-4">
											<input type="text" placeholder="국가명 검색" value="<?php echo !empty($req) ? $req['keyword'] : ''; ?>" name="keyword" id="keyword" class="form-control" />
										</div>
									</div>
								</div>
							</form>
                    	...
                    	<div class="ibox ">
                        	<div class="ibox-content">
								<div class="form-group float-right text-right col-lg-6">
									<a href="/admin/overseas/nation/register" class="btn btn-primary">국가등록</a>
								</div>
                            	...
                            	<table class="footable table table-stripped">
									...
									?>
                                                <tr>
													...
													<td class="text-center">
                                                        <a href="#" onclick="javascript:goDetail('<?php echo $row['seq']; ?>'); return false;">
															<?php echo $row['nation_name_eng']; ?>
                                                        </a>
													</td>
													<td class="text-center">
                                                        <a href="#" onclick="javascript:goDetail('<?php echo $row['seq']; ?>'); return false;">
															<?php echo $row['nation_code']; ?>
                                                        </a>
													</td>
													<td class="text-center"><?php echo $row['currency']; ?></td>
													<td class="text-center"><?php echo $row['language']; ?></td>
													<td class="text-center"><?php echo $row['fta_status']; ?></td>
...
function goPage(offset) {
	$('#frmSearch').attr('action', '/admin/overseas/nation/list');
	$('input[name=offset]').val(offset);
	$('#frmSearch').submit();
}

function goDetail(seq) {
	$('#frmSearch').attr('action', '/admin/overseas/nation/edit');
