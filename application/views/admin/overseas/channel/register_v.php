							...
							<form id="frmSave">
                                <div class="ibox-content">
                                    ...
                                    <div class="form-group  row">
	                                    ...
	                                    <div class="col-lg-4 ">
											<input type="text" name="channel_name_eng"  value="" class="form-control" />
	                                    </div>
                                    </div>
	                                <div class="hr-line-dashed"></div>
                                    <div class="form-group  row">
	                                    ...
	                                    <div class="col-lg-4 ">
											<input type="text" name="channel_name_origin"  value="" class="form-control" />
	                                    </div>
                                    </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
...
function fnSave()
{
	...
	$.ajax({
		url: "/api/admin/overseas/channel/register",
		type: "POST",
		data: data,
