							...
							<form id="frmSearch" method="post" action="/admin/overseas/nation/list" >
								...
								<div class="ibox-content">
									<div class="row">
										...
										<div class="col-lg-4">
											<input type="text" placeholder="국가명, 채널명 검색" value="<?php echo !empty($req) ? $req['keyword'] : ''; ?>" name="keyword" id="keyword" class="form-control" />
										</div>
									</div>
								</div>
							</form>
                    	...
                    	<div class="ibox ">
                        	<div class="ibox-content">
								<div class="form-group float-right text-right col-lg-6">
									<a href="/admin/overseas/channel/register" class="btn btn-primary">채널등록</a>
								</div>
                            	...
                            	<table class="footable table table-stripped">
                                	<thead>
                                		<tr>
		                                    ...
		                                    <th class="text-center">채널명(영문)</th>
		                                    <th class="text-center">채널명(원어명)</th>
									...
									?>
                                                <tr>
													...
													<td class="text-center">
                                                        <a href="#" onclick="javascript:goDetail('<?php echo $row['seq']; ?>'); return false;">
															<?php echo $row['channel_name_eng']; ?>
                                                        </a>
													</td>
													<td class="text-center">
                                                        <a href="#" onclick="javascript:goDetail('<?php echo $row['seq']; ?>'); return false;">
															<?php echo $row['channel_name_origin']; ?>
                                                        </a>
													</td>
...
function goPage(offset) {
	$('#frmSearch').attr('action', '/admin/overseas/channel/list');
	$('input[name=offset]').val(offset);
	$('#frmSearch').submit();
}

function goDetail(seq) {
	$('#frmSearch').attr('action', '/admin/overseas/channel/edit');
