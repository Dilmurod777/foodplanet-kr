							...
							<form id="frmSearch" method="post" action="/admin/overseas/nation/list" >
								...
								<div class="ibox-content">
									<div class="row">
										...
										<div class="col-lg-4">
											<input type="text" placeholder="국가명, 품목명, HSCODE 검색" value="<?php echo !empty($req) ? $req['keyword'] : ''; ?>" name="keyword" id="keyword" class="form-control" />
										</div>
									</div>
								</div>
							</form>
                    	...
                    	<div class="ibox ">
                        	<div class="ibox-content">
								<div class="form-group float-right text-right col-lg-6">
									<a href="/admin/overseas/requirement/register" class="btn btn-primary">수입요건등록</a>
								</div>
...
function goPage(offset) {
	$('#frmSearch').attr('action', '/admin/overseas/requirement/list');
	$('input[name=offset]').val(offset);
	$('#frmSearch').submit();
}

function goDetail(seq) {
	$('#frmSearch').attr('action', '/admin/overseas/requirement/edit');
