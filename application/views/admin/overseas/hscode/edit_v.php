    ...
    <div id="page-wrapper" class="gray-bg">
		...
		<div class="wrapper wrapper-content animated fadeInRight">
                        ...
                        <div class="ibox ">
							<form id="frmSave">
                                ...
                                <div class="ibox-content">
	                                ...
	                                <div class="hr-line-dashed"></div>
                                    <div class="form-group  row">
                                        <label class="col-lg-2 col-form-label">설명<code>*</code></label>
	                                    <div class="col-lg-10 ">
											<textarea name="desc" class="form-control" rows="7"><?php echo $info['desc']; ?></textarea>
	                                    </div>
                                    </div>
			...
			<div class="form-group text-center">
	           	...
	           	<button type="button" class="btn btn-w-m btn-default" onclick="javascript:location.href='/admin/overseas/hscode/list'; return false;">목록으로</button>
			</div>
		</div>
    </div>
</div>
...
function fnSave()
{
	...
	$.ajax({
		url: "/api/admin/overseas/hscode/edit",
		type: "POST",
		data: data,
		...
		success:function(data){
			data = JSON.parse(data);
       		if(data.result == 'login') {
                ...
                alert(data.msg);
                location.href='/admin/overseas/hscode/list';
       		}
       	},
        error:function(data){
    		fnHideLoad();
...
function fnDelete() {
	...
	$.ajax({
		url: "/api/admin/overseas/hscode/delete",
		type: "POST",
