							...
							<form id="frmSearch" method="post" action="/admin/overseas/nation/list" >
								...
								<div class="ibox-content">
									<div class="row">
										...
										<div class="col-lg-4">
											<input type="text" placeholder="국가명,품목명 검색" value="<?php echo !empty($req) ? $req['keyword'] : ''; ?>" name="keyword" id="keyword" class="form-control" />
										</div>
									</div>
								</div>
							</form>
                    	...
                    	<div class="ibox ">
                        	<div class="ibox-content">
								<div class="form-group float-right text-right col-lg-6">
									<a href="/admin/overseas/np/register" class="btn btn-primary">국가별품목등록</a>
								</div>
                            	...
                            	<table class="footable table table-stripped">
									...
									?>
                                                <tr>
													...
													<td class="text-center"><?php echo number_format($row['export_price']); ?></td>
...
function goPage(offset) {
	$('#frmSearch').attr('action', '/admin/overseas/np/list');
	$('input[name=offset]').val(offset);
	$('#frmSearch').submit();
}

function goDetail(seq) {
	$('#frmSearch').attr('action', '/admin/overseas/np/edit');
