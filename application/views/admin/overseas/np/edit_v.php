							...
							<form id="frmSave">
                                ...
                                <div class="ibox-content">
                                    <div class="form-group  row">
										...
										<?php
											foreach($nation as $row) {
												...
												echo '	<input type="radio" id="nation_seq_' .  $row['seq'] . '" name="nation_seq" value="' . $row['seq'] . '" ' . ($info['nation_seq'] === $row['seq'] ? 'checked' : '') . ' >';
                                    ...
                                    <div class="form-group  row">
										...
										<?php
											foreach($product as $row) {
												echo '<div class="col-lg-3 check_wrap">';
												echo '	<input type="radio" id="product_seq_' .  $row['seq'] . '" name="product_seq" value="' . $row['seq'] . '" ' . ($info['product_seq'] === $row['seq'] ? 'checked' : '') . ' >';
	                                ...
	                                <div class="form-group  row">
	                                    ...
	                                    <div class="col-sm-4" >
											<input type="text" name="export_price" class="form-control onlyNumber2" value="<?php echo number_format($info['export_price']); ?>" />
										</div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
	                                    ...
	                                    <div class="col-sm-4" id="distribution_status_wrap">
											<input type="text" class="form-control" value="<?php echo $info['distribution_status']; ?>" disabled />
										</div>
										<div class="col-sm-1">
...
function fnSave()
{
	...
	$.ajax({
		url: "/api/admin/overseas/np/edit",
		type: "POST",
		data: data,
...
function fnDelete() {
	...
	$.ajax({
		url: "/api/admin/overseas/np/delete",
		type: "POST",
