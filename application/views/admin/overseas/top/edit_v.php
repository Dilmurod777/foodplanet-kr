							...
							<form id="frmSave">
                                ...
                                <div class="ibox-content">
	                                ...
	                                <div class="form-group  row">
	                                    ...
	                                    <div class="col-sm-4" >
											<input type="text" name="price" class="form-control onlyNumber2" value="<?php echo number_format($info['price']); ?>" />
										</div>
	                                </div>
	                                <div class="hr-line-dashed"></div>
	                                <div class="form-group  row">
	                                    ...
	                                    <div class="col-sm-4" >
											<input type="text" name="order_no" class="form-control onlyNumber" value="<?php echo $info['order_no']; ?>" />
										</div>
	                                </div>
...
function fnSave()
{
	...
	$.ajax({
		url: "/api/admin/overseas/top/edit",
		type: "POST",
		data: data,
...
function fnDelete() {
	...
	$.ajax({
		url: "/api/admin/overseas/top/delete",
		type: "POST",
