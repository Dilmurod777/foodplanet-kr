                    	...
                    	<div class="ibox ">
                        	<div class="ibox-content">
								<div class="form-group float-right text-right col-lg-6">
									<a href="/admin/overseas/top/register" class="btn btn-primary">국가대표품목등록</a>
								</div>
...
function goPage(offset) {
	$('#frmSearch').attr('action', '/admin/overseas/top/list');
	$('input[name=offset]').val(offset);
	$('#frmSearch').submit();
}

function goDetail(seq) {
	$('#frmSearch').attr('action', '/admin/overseas/top/edit');
