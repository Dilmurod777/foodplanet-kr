                    	...
                    	<div class="ibox ">
                        	<div class="ibox-content">
								<div class="form-group float-right text-right col-lg-6">
									<a href="/admin/overseas/trends/register" class="btn btn-primary">시장동향등록</a>
								</div>
...
function goPage(offset) {
	$('#frmSearch').attr('action', '/admin/overseas/trends/list');
	$('input[name=offset]').val(offset);
	$('#frmSearch').submit();
}

function goDetail(seq) {
	$('#frmSearch').attr('action', '/admin/overseas/trends/edit');
