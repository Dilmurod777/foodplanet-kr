    ...
    <div id="page-wrapper" class="gray-bg">
		...
		<div class="wrapper wrapper-content animated fadeInRight">
														...
														?>
																	<tr>
																		...
																		<td class="text-center">
																			<a href="/mypage/product/ownedit/<?php  echo $row['detail_seq']; ?>">
			...
			<div class="form-group text-center">
					<button type="button" class="btn btn-w-m btn-success" onclick="location.href='/mypage/product/ownregister'">제품등록</button>
			</div>
		</div>
    </div>
</div>
...
function goPage(page) {
    $('#frmSearch').attr('action', '/product/ownlist/' + page);
    $('#frmSearch').submit();
}
</script>