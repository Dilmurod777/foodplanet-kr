												...
												<div class="col-sm-4">
													...
													<?php
														foreach($company as $row) {
															echo '<option value="' . $row['sub_code'] . '" ' . ($row['sub_code'] === $info['brand'] ? 'selected' : '') . '>' . $row['code_name'] . '</option>';
														}
													?>
													</select>
												</div>
									...
									<div class="ibox-content ">
										...
										<div class="panel-body" >
											<div class="form-group  row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" name="type_a" value="<?php echo $info['type_a']; ?>" placeholder="용기 타입 및 입수 등 정보를 입력해 주세요." />
												</div>
											</div>
											<div class="hr-line-dashed"></div>
											<div class="form-group  row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" name="type_b" value="<?php echo $info['type_b']; ?>" placeholder="용기 타입 및 입수 등 정보를 입력해 주세요." />
												</div>
											</div>
											<div class="hr-line-dashed"></div>
											<div class="form-group  row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" name="type_c" value="<?php echo $info['type_c']; ?>" placeholder="용기 타입 및 입수 등 정보를 입력해 주세요." />
												</div>
											</div>
										</div>
									</div>
...
function fnCancel() {
	showConfirm('입력한 내용을 취소하시겠습니까?', function() { location.href = '/mypage/product/oemlist'; });
}
</script>