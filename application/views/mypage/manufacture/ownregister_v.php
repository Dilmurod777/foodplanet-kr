									...
									<div class="ibox-content ">
										...
										<div class="panel-body" >
											<div class="form-group  row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" name="brand" value="" placeholder="해당 제품의 NB브랜드를 입력해 주세요. 입력하지 않는 경우 제조사명이 출력됩니다." />
												</div>
											</div>
											<div class="hr-line-dashed"></div>
											<div class="form-group  row">
									...
									<div class="ibox-content ">
										...
										<div class="panel-body" >
											...
											<div class="form-group  row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" name="type_cnt" value="" placeholder="용기 타입과 포장 입수를 입력하세요." />
												</div>
											</div>
										</div>
									</div>
