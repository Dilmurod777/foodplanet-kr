						...
						<div class="gallery-wrap clear">
							...
							<div class="pro-detail-right sticky-box">
								<dl class="profie-info">
									<dt><?php echo $info['product_name']; ?><a href="javascript:;" class="btn-like">관심상품</a></dt>
									<dd>
	...
	$(".btn-like").on('click', function(e){
		...
		?>
			...
			$.ajax({
					...
					type: "POST",
					data: {target_cd : '<?php echo $info['product_seq']; ?>', is_wish : isWish, target_type : '<?php echo $req['prod_type'] === 'nb' ? '2' : '3'; ?>'},
					async : false,
					dataType : 'json';
