...
Class Nbproduct extends FP_ApiController {
    ...
    public function register()
    {
        ...
        if(empty($req['chk_biz_no']) || $req['chk_biz_no'] === 'n') {
            ...
            if($result['result'] == 'succ') {
                ...
                $req['imgs'] = $imgs;
                $this->domestic_m->insert_nbproduct($req);
                $result['msg'] = '등록하였습니다.';
                $this->log_m->insert_log('tb_domestic_product', 'C', $req, $this->data['admin']['admin_id']);
            }
        }
    ...
    public function edit()
    {
        ...
        if($result['result'] == 'succ') {
            ...
            if($result['result'] === 'succ') {
                ...
                $this->domestic_m->update_nbproduct($req);
                $result['msg'] = '수정하였습니다.';
                $this->log_m->insert_log('tb_domestic_product', 'U', $req, $this->data['admin']['admin_id']);
            }
        }
    ...
    public function delete()
    {
        ...
        if(empty($req['seq'])) {
            ...
            $this->domestic_m->delete_nbproduct($req);

            $result['result'] = 'succ';
            $result['msg'] = '삭제되었습니다.';
            $this->log_m->insert_log('tb_domestic_product', 'D', $req, $this->data['admin']['admin_id']);
        }
