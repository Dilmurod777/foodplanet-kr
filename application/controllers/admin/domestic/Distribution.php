...
Class Distribution extends FP_AdminController {
	...
	public function list() {
		...
		$this->load->view('admin/domestic/distribution/list_v');
		$this->load->view('admin/common/include/footer_v');
	}

	public function register() {
		$this->load->view('admin/common/include/header_v', $this->data);
		$this->load->view('admin/domestic/distribution/register_v');
		$this->load->view('admin/common/include/footer_v');
	}
	...
	public function edit() {
        $req = $this->input->post();
        if(empty($req['biz_no'])) {
            header('Location: /admin/domestic/distribution/list');
            exit;
        }
        ...
        $this->data['info'] = $info;
		$this->load->view('admin/common/include/header_v', $this->data);
		$this->load->view('admin/domestic/distribution/edit_v');
		$this->load->view('admin/common/include/footer_v');
	}
}