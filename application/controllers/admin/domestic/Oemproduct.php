...
Class Oemproduct extends FP_AdminController {
	...
	public function list() {
		...
		$this->load->view('admin/domestic/oemproduct/list_v');
	...
	public function register() {
		...
		$this->load->view('admin/common/include/header_v', $this->data);
		$this->load->view('admin/domestic/oemproduct/register_v');
		$this->load->view('admin/common/include/footer_v');
	}
	...
	public function edit() {
        $req = $this->input->post();
        if(empty($req['seq'])) {
            header('Location: /admin/domestic/oemproduct/list');
            exit;
        }
        $info = $this->domestic_m->oemproduct_info($req['seq'])->row_array();
        if(empty($info)) {
            header('Location: /admin/domestic/oemproduct/list');
            exit;
        }
		...
		$this->load->view('admin/common/include/header_v', $this->data);
		$this->load->view('admin/domestic/oemproduct/edit_v');
		$this->load->view('admin/common/include/footer_v');
	}
}